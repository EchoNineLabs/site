...
- [**Hangar** (hangar.papermc.io/Saturn/Kite)](https://hangar.papermc.io/Saturn/Kite)
...
**Example**
{{< callout type="error" >}}
  Function **Player#getTargetBlock** cannot be called outside of the main thread.  
  This will result in an exception being thrown.
{{< /callout >}}
```kts
val targetBlock = Bukkit.getPlayer("Player").getTargetBlock()
...
{{< cards cols="3" >}}
  {{< card link="https://modrinth.com/plugin/kite" title="Troubleshooting" subtitle="Conflicting Imports (TODO)" >}}
{{< /cards >}}
